...
void	plAddChildShape(plCollisionShapeHandle compoundShapeHandle,plCollisionShapeHandle childShapeHandle, plbtVector3 childPos,plQuaternion childOrn)
{
...
//	extern  void		plAddTriangle(plMeshInterfaceHandle meshHandle, plbtVector3 v0,plbtVector3 v1,plbtVector3 v2);
...
void plSetScaling(plCollisionShapeHandle cshape, plbtVector3 cscaling)
{
	btCollisionShape* shape = reinterpret_cast<btCollisionShape*>( cshape);
	btAssert(shape);
...
void plSetPosition(plRigidBodyHandle object, const plbtVector3 position)
{
	btRigidBody* body = reinterpret_cast< btRigidBody* >(object);
	btAssert(body);
...
void	plGetPosition(plRigidBodyHandle object,plbtVector3 position)
{
	btRigidBody* body = reinterpret_cast< btRigidBody* >(object);
	btAssert(body);
...
//plRigidBodyHandle plRayCast(plDynamicsWorldHandle world, const plbtVector3 rayStart, const plbtVector3 rayEnd, plbtVector3 hitpoint, plbtVector3 normal);

//	extern  plRigidBodyHandle plObjectCast(plDynamicsWorldHandle world, const plbtVector3 rayStart, const plbtVector3 rayEnd, plbtVector3 hitpoint, plbtVector3 normal);
