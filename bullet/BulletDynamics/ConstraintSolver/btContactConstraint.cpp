		...
		btScalar distance)
{
	...
	body1->applyImpulse(normal*(normalImpulse), rel_pos1, "btContactConstraint - response  between two dynamic objects without friction and no restitution");
    if (body2)
		body2->applyImpulse(-normal*(normalImpulse), rel_pos2, "btContactConstraint - response  between two dynamic objects without friction and no restitution");
