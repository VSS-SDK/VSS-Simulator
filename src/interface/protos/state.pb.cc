...
void protobuf_AssignDesc_state_2eproto() {
  ...
  static const int Global_State_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Global_State, team_attack_dir_),
  };
...
const int Global_State::kTeamAttackDirFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_team_attack_dir;
        break;
      }
      ...
      case 7: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_team_attack_dir:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 input, &team_attack_dir_)));
          set_has_team_attack_dir();
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectAtEnd()) return true;
...
void Global_State::SerializeWithCachedSizes(
  ...
  // required uint32 team_attack_dir = 7;
  if (has_team_attack_dir()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(7, this->team_attack_dir(), output);
  }
...
::google::protobuf::uint8* Global_State::SerializeWithCachedSizesToArray(
  ...
  // required uint32 team_attack_dir = 7;
  if (has_team_attack_dir()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(7, this->team_attack_dir(), target);
  }
...
void Global_State::MergeFrom(const Global_State& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_team_attack_dir()) {
      set_team_attack_dir(from.team_attack_dir());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
bool Global_State::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000062) != 0x00000062) return false;
...
void Global_State::Swap(Global_State* other) {
  if (other != this) {
    ...
    std::swap(team_attack_dir_, other->team_attack_dir_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
