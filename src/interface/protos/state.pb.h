...
class Global_State : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_team_attack_dir() const;
  inline void clear_team_attack_dir();
  static const int kTeamAttackDirFieldNumber = 7;
  inline ::google::protobuf::uint32 team_attack_dir() const;
  inline void set_team_attack_dir(::google::protobuf::uint32 value);
 ...
 private:
  ...
  inline void set_has_team_attack_dir();
  inline void clear_has_team_attack_dir();
  ...
  ::google::protobuf::uint32 team_attack_dir_;
...
// required uint32 team_attack_dir = 7;
inline bool Global_State::has_team_attack_dir() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void Global_State::set_has_team_attack_dir() {
  _has_bits_[0] |= 0x00000040u;
}
inline void Global_State::clear_has_team_attack_dir() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void Global_State::clear_team_attack_dir() {
  team_attack_dir_ = 0u;
  clear_has_team_attack_dir();
}
inline ::google::protobuf::uint32 Global_State::team_attack_dir() const {
  return team_attack_dir_;
}
inline void Global_State::set_team_attack_dir(::google::protobuf::uint32 value) {
  set_has_team_attack_dir();
  team_attack_dir_ = value;
}
