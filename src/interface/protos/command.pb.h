...
class Robot_Command : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vss_command.Robot_Command) */ {
 public:
  Robot_Command();
...
class Global_Commands : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vss_command.Global_Commands) */ {
 public:
  Global_Commands();
